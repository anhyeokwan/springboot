...
public interface BoardService {
    ...
    // 댓글의 숫자까지 처리
    PageResopneseDTO<BoardListReplyCountDTO> listWithReplyCount(PageRequestDTO pageRequestDTO);

    // 게시글의 이미지와 댓글의 숫자끼리 처리
    PageResopneseDTO<BoardListAllDTO> listWithAll(PageRequestDTO pageRequestDTO);
